...
export function CartView({ setCurrentView }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 pt-24 md:pt-28 pb-12">
      ...
      {items.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-3xl border border-gray-200">
          ...
          <button onClick={() => setCurrentView('productos')} className="mt-4 px-6 py-2 bg-[#00C2FF] text-white rounded-xl text-xs font-bold">Ir a la tienda</button>
        </div>
      ) : (
