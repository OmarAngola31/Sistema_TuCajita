...
export function ProductDetail({ setCurrentView }) {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 pt-24 md:pt-28 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-6 lg:col-span-5 bg-[#D2E7EA] rounded-3xl p-6 shadow-sm text-gray-900">
          ...
          <div className="mt-6">
            ...
            {btnState === 'success' && <button onClick={() => setCurrentView('carrito')} className="w-full py-3.5 bg-[#1E7E34] text-white font-black rounded-xl shadow flex items-center justify-center space-x-2 animate-bounce"><span>✓ Producto añadido</span></button>}
          </div>
        </div>
      </div>
    </div>
